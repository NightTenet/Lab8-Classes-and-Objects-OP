            ...
            while (choice != "0")
            {
                ...
                try
                {
                    switch (choice)
                    {
                        ...
                        case "2":
                            {
                                ...
                                Category? cat = wh.GetCategoryByName(name);
                                if (wh.RemoveCategory(cat))
                        ...
                        case "3":
                            {
                                ...
                                Category? cat = wh.GetCategoryByName(oldName);
                                if (cat != null)
                                {
                                    wh.ChangeCategoryData(cat, newName);
                        ...
                        case "6":
                            {
                                ...
                                Category cat = wh.GetCategoryByName(catName);
                                if (cat == null)
                                    Console.WriteLine("\nThere's no such category!");
                                else
                                {
                                    ...
                                    wh.AddProductToCategory(cat, prod);
                        ...
                        case "7":
                            {
                                ...
                                else
                                {
                                    ...
                                    Product prod = wh.GetProductByName(prodName, cat);
                                    if (prod == null)
                                        Console.WriteLine("There's no such product in that category!");
                                    else
                                    {
                                        wh.RemoveProductInCategory(cat, prod);
                        ...
                        case "8":
                            {
                                ...
                                Product prod = wh.GetProductByName(oldName);
                                if (prod == null)
                                ...
                                else
                                {
                                    ...
                                    wh.ChangeProductData(prod, newName, quantity, price, trademark);
                        ...
                        case "9":
                            {
                                ...
                                else
                                {
                                    ...
                                    wh.ChangeProductQuantity(prod, quantity);
                        ...
                        case "10":
                            {
                                ...
                                Product? prod = wh.GetProductByName(name);
                                if (prod != null)
                                    Console.WriteLine("\n" + prod.ToString());
                                else
                        ...
                        case "11":
                            {
                                var prodList = wh.GetAllProducts();
                                if (prodList.Count == 0)
                                    Console.WriteLine("List is empty!");
                                else
                                {
                                    ...
                                    {
                                        case "1":
                                                sortedList = wh.SortAllProductsByName();
                                                break;
                                        case "2":
                                                sortedList = wh.SortAllProductsByTrademark();
                                                break;
                                        case "3":
                                                sortedList = wh.SortAllProductsByPrice();
                                                break;
                                    }
                        ...
                        case "13":
                            {
                                ...
                                Supplier? supp = wh.GetSupplierByNS(name, surname);
                                if (wh.RemoveSupplier(supp))
                        ...
                        case "14":
                            {
                                ...
                                if (supp != null)
                                {
                                    ...
                                    wh.ChangeSupplierData(supp, newName, newSurname, newCompany);
                        ...
                        case "16":
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case "1":
                                                sortedList = wh.SortAllSuppliersByName();
                                                break;
                                        case "2":
                                                sortedList = wh.SortAllSuppliersBySurname();
                                                break;
                                        default:
                                            break;
                                    }
                        ...
                        case "17":
                            {
                                ...
                                var result = wh.SearchByKeywordInProducts(keyword);
                        ...
                        case "18":
                            {
                                ...
                                var result = wh.SearchByKeywordInSuppliers(keyword);
